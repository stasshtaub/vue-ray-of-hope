    ...
    <div class="container">
      <div class="right">
        ...
        <p>
          ...
          <br />Наша команда состоит из людей, которые хотят, чтобы эта фраза стала ложью.
        </p>
        <p>
          Мы реализуем информационную благотворительную площадку, главная цель которой - сделать проще и понятней процесс помощи нуждающимся.
          <br />Мы создаем информационную платформу, объединяющую неравнодушных людей, готовых помочь, и людей, которым эта помощь нужна.
        </p>
        <p>
          Площадка, ориентированная под нужды благотворительных организаций…
          <br />Площадка, на которой граждане увидят информацию в одном месте и смогут помочь, просто нажав на кнопку…
          <br />Площадка, чтобы творить добро!
          <br />Площадка, которую освещает луч надежды!
        </p>
      </div>
    </div>
  </section>
...
.about-screen .hand, .about-screen .heart {
  fill: white;
}
.about-screen .heart {
  fill-rule: nonzero;
