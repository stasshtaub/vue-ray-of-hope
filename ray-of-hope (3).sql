...
INSERT INTO `doc` (`id`, `organization`, `url`, `preview`) VALUES
(1, 19, '/content/organizations/19/docs/1/demo.docx', '/content/organizations/19/docs/1/demo.png'),
(2, 19, '/content/organizations/19/docs/1/demo.docx', '/content/organizations/19/docs/1/demo.png'),
(3, 19, '/content/organizations/19/docs/1/demo.docx', '/content/organizations/19/docs/1/demo.png'),
(4, 19, '/content/organizations/19/docs/1/demo.docx', '/content/organizations/19/docs/1/demo.png'),
(5, 19, '/content/organizations/19/docs/1/demo.docx', '/content/organizations/19/docs/1/demo.png'),
(6, 19, '/content/organizations/19/docs/1/demo.docx', '/content/organizations/19/docs/1/demo.png'),
(7, 19, '/content/organizations/19/docs/1/demo.docx', '/content/organizations/19/docs/1/demo.png'),
(8, 19, '/content/organizations/19/docs/1/demo.docx', '/content/organizations/19/docs/1/demo.png'),
(9, 19, '/content/organizations/19/docs/1/demo.docx', '/content/organizations/19/docs/1/demo.png');
...
INSERT INTO `type_account` (`name`, `description`) VALUES
('гражданин', NULL),
('организация', NULL);
...
INSERT INTO `type_of_activity` (`name`) VALUES
('Животные'),
('Онкобольные');
...
CREATE TABLE `user` (
  `id` int(11) UNSIGNED NOT NULL,
  `type_of_account` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `avatar` varchar(2083) COLLATE utf8_unicode_ci DEFAULT NULL,
  `description` varchar(1000) COLLATE utf8_unicode_ci DEFAULT NULL,
  `email` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `password` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `token` varchar(8) COLLATE utf8_unicode_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
ALTER TABLE `bookmark`
  ADD PRIMARY KEY (`note`,`user`) USING BTREE,
  ADD KEY `user` (`user`);
...
--
ALTER TABLE `note`
  ADD PRIMARY KEY (`id`,`author`) USING BTREE,
  ADD KEY `type_note` (`type`),
...
ALTER TABLE `organization`
  ...
  ADD KEY `type of activity` (`activity`);
...
ALTER TABLE `user`
  ADD PRIMARY KEY (`id`),
  ADD KEY `type_of_account` (`type_of_account`);
...
--
ALTER TABLE `bookmark`
  ADD CONSTRAINT `bookmark_ibfk_2` FOREIGN KEY (`user`) REFERENCES `user` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
ALTER TABLE `doc`
  ADD CONSTRAINT `doc_ibfk_1` FOREIGN KEY (`organization`) REFERENCES `organization` (`user_id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Ограничения внешнего ключа таблицы `event`
--
ALTER TABLE `event`
  ADD CONSTRAINT `event_ibfk_1` FOREIGN KEY (`note`) REFERENCES `note` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
ALTER TABLE `message`
  ADD CONSTRAINT `message_ibfk_1` FOREIGN KEY (`fromUser`) REFERENCES `user` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `message_ibfk_2` FOREIGN KEY (`toUser`) REFERENCES `user` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE `organization`
  ...
  ADD CONSTRAINT `organization_ibfk_4` FOREIGN KEY (`activity`) REFERENCES `type_of_activity` (`name`) ON DELETE SET NULL ON UPDATE CASCADE;
...
--
ALTER TABLE `user`
  ADD CONSTRAINT `user_ibfk_1` FOREIGN KEY (`type_of_account`) REFERENCES `type_account` (`name`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
